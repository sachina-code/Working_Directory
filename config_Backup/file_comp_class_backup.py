...
class fileCompare:
    ...
    def compare_files(self):
        masterFileName = '/root/Working_Directory/config_Backup/' + self.device_name + '_config_Master.txt'
        tmpFileName = '/root/Working_Directory/config_Backup/' + self.device_name + '_config_tmp.txt'
        tmpFileName1 = '/root/Working_Directory/config_Backup/' + self.device_name + '_config_tmp1.txt'
    ...
    def save_config(self):             
        if not filecmp.cmp(tmpFileName1, masterFileName):
            ...
            backupFile = '/root/STC_Config_Backup/' + date + '/' + self.device_name + '_Config_' + date + '.cfg'
