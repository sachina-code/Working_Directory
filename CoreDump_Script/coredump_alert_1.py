...
for device in devices.keys():
    ...
    tmpFileName1 = '/root/Working_Directory/CoreDump_Script/' + device + '_coredump_output_tmp1.txt'
    ...
    if not filecmp.cmp(tmpFileName1, masterFileName):
        ...
        sendmail.send_mail("sachina@juniper.net", "sachina@juniper.net", device, masterFileName)        
